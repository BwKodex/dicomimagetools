...
def test_ct_series_add_file_sorts_on_instance_number_when_slice_location_and_image_position_patient_missing(
    ...
    fp_first_slice = example_data_path_fixture["ct"] / "GE" / "MissingSliceLocationAndImagePositionPatientSeries" / "1"
    fp_last_slice = example_data_path_fixture["ct"] / "GE" / "MissingSliceLocationAndImagePositionPatientSeries" / "2"
