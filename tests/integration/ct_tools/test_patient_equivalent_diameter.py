from dicom_image_tools.ct_tools.patient_equivalent_diameter import _calculate_slice_area_equivalent_diameter,\
    calculate_area_equivalent_diameter, SinogramData
from dicom_image_tools.dicom_handlers.ct import CtSeries
from dicom_image_tools.helpers.voxel_data import VoxelData
from dicom_image_tools.ct_tools.patient_equivalent_diameter import EquivalentDiameterData
import numpy as np
import pytest
...
def test_calculate_area_equivalent_diameter(ct_series):
    expected = EquivalentDiameterData(
        Area_px=152927.0,
        EAD_px=441.2626245873473, EAD_cm=21.546015559613455,
        EquivalentAreaCircumference_cm=67.688804196213,
        MeanHU=86.66725300306682, MedianHU=125.0,
        LAT_cm=21.5820202, AP_cm=21.5331921,
        WED_px=459.9868683189358, WED_cm=22.46028480496383,
        EED_px=441.4997168742014, EED_cm=21.557592325505194)
